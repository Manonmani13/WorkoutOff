...
//	}
	...
	public ResponseTemplate getByCustomerProductId(long customerId) {
		ResponseTemplate  rt=new ResponseTemplate();
		Customer customer=customerRepository.getByCustomerId(customerId);
		Product product=restTemplate.getForObject("http://localhost:8082/product/"+customer.getCustomerId(), Product.class);

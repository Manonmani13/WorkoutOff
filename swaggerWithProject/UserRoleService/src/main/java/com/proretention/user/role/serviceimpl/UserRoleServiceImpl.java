package com.proretention.user.role.serviceimpl;
...
import com.proretention.user.role.exception.ResourceNotFound;
import com.proretention.user.role.repository.UserRoleRepository;
...
public class UserRoleServiceImpl implements UserRoleService {
	...
	public UserRoleResponse createRole(UserRoleDto userRoleDto) {
		...
		if(userRoleDto.getRoleId()==0||userRoleDto.getUserRole().isBlank()||userRoleDto.getUserRole().isEmpty())
	...
	public UserRoleDto updateRole(int id, UserRoleDto dto) {
		...
		if(dto.getRoleId()==0||dto.getUserRole().isBlank()||dto.getUserRole().isEmpty())
			throw new  ResourceNotFound("please give proper input because there is some filed null");
		}
		catch(ResourceNotFound rs)
		{
